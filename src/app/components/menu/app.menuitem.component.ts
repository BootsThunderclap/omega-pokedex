...
@Component({
  ...
  template: `
    <ng-container>
      ...
      <ul *ngIf="item.items && isActive" [@children]="isActive ? 'visibleAnimated' : 'hiddenAnimated'">
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
  ...
  @HostBinding('class.active-menuitem') public get isActive() {
    return this.active;
  }
